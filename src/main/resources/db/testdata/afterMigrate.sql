...
insert into usuario (id,nome,email,senha,data_cadastro) VALUES (1,'Tinho Roberto','tinho@email.com','123456',utc_timestamp);
insert into usuario (id,nome,email,senha,data_cadastro) VALUES (2,'Cinha Miranda','cinha@email.com','123456',utc_timestamp);
insert into usuario (id,nome,email,senha,data_cadastro) VALUES (3,'Guito Jofrey','guito@email.com','123456',utc_timestamp);
insert into usuario (id,nome,email,senha,data_cadastro) VALUES (4,'Alcururu','alcas@email.com','123456',utc_timestamp);
...
values (1,'78e4fff2-afbb-4ad0-a244-4d76cb4677c9', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
        endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        status, data_criacao, subtotal, taxa_frete, valor_total)
values (2,'2337d022-5a1b-4da0-8b75-0301de89cd31', 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
