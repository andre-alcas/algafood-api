...
public interface RestauranteControllerOpenApi {
	...
	RestauranteModel buscar(@ApiParam(value="ID de um"+className, example="1",required=true) Long restauranteId);
	...
	RestauranteModel adicionar(@ApiParam(name="corpo",value="Representação de um novo"+className,required=true) RestauranteInput restauranteInput);
	...
	@ApiResponses({
		@ApiResponse(code=204,message=className+"inativado(s) com sucesso"),
